...
intent_responses = {
        ...
        "campus_directions_cafeteria": {
            "text": (
                "To get to the cafeteria from the A-Block, go from the main entracnce(the Entrance with Sercurity Station) towards the Bus Station "
                "To get to the cafeteria from the B-Block, walk out from the main entrance (the Entrance with Sercurity Station)too, then walk towards your right for 3 minutes you will get   "
            ),
            "image": ""
        },      
